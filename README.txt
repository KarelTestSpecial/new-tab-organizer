...
This extension uses a hybrid storage model to provide a balance of synchronization and flexibility:
  ...
  - Synced Data (chrome.storage.sync): The structure of your panels, text in your notes, settings, and bookmark data are all synchronized across your devices using your browser's built-in sync feature.
  - Local Data (chrome.storage.local): To accommodate larger data like images, all pasted images are saved only on the local machine where they were added.

NOTE: Your layout and text-based notes will always be in sync, but pasted images will not appear on your other devices.
